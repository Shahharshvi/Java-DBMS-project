...
import java.sql.ResultSet;//A ResultSet object is a table of data 
//representing a database result set, which is usually generated by executing a statement that queries the database.
...
import javax.swing.table.DefaultTableModel;//This is an implementation of TableModel that uses a Vector of Vectors to store the cell value objects.
//returns column of class object.
...
String sql1 = "SELECT flightcode FROM `manageflight` WHERE flightcode ='"+id+"'";
//int n=Integer.parseInt(sql1);
if (!(sql1.isEmpty())) {
